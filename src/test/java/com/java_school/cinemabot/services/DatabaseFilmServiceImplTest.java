...
import com.java_school.cinemabot.services.external.fake_services.FakeExternalFilmService;
...
class DatabaseFilmServiceImplTest {
    ...
    @MockBean
    private FakeExternalFilmService externalFilmService;
